    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image2', models.ImageField(blank=True, null=True, upload_to=question_bank.models.upload_location)),
                ('image3', models.ImageField(blank=True, null=True, upload_to=question_bank.models.upload_location)),
                ('image4', models.ImageField(blank=True, null=True, upload_to=question_bank.models.upload_location)),
                ('image5', models.ImageField(blank=True, null=True, upload_to=question_bank.models.upload_location)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image2', models.ImageField(blank=True, upload_to='ans_images')),
                ('image3', models.ImageField(blank=True, upload_to='ans_images')),
                ('image4', models.ImageField(blank=True, upload_to='ans_images')),
                ('image5', models.ImageField(blank=True, upload_to='ans_images')),
                ('image6', models.ImageField(blank=True, upload_to='ans_images')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
